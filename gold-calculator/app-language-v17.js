...
const translations={en:window.SAIFKS_LANG_EN,ar:window.SAIFKS_LANG_AR};
...
function applyLanguage(language){
  ...
  document.title=`${text.title} | SaifKS`;const ls=document.getElementById("languageSelect");if(ls)ls.value=language;
...
document.getElementById("languageSelect").addEventListener("change",function(){applyLanguage(this.value);saveState();});
