...
function clearUpgradePlan(){
  ...
  document.getElementById("plannerCurrent").value="";
...
function collectState(){
  const state={
    ...
    fields:{},
    buildings:{},planner:{current:document.getElementById("plannerCurrent")?.value||"",target:document.getElementById("plannerTarget")?.value||""}
  };
...
function restoreState(){
  ...
  try{
    ...
    if(state.planner){
      ...
      if(plannerCurrent) plannerCurrent.value=state.planner.current||"";
...
document.getElementById("confirmReset").addEventListener("click",()=>{
  ...
  document.querySelectorAll("select").forEach(element=>{
    if(element.id==="plannerCurrent"||element.id==="plannerTarget"){
      element.value="";
